...
namespace TP.ConcurrentProgramming.Presentation.Model
{
    ...
    internal class ModelImplementation : ModelAbstractApi
    {
        ...
        public override void Start(int numberOfBalls, double diameter, WindowData windowData)
        {
            ...
            layerBellow.Start(numberOfBalls, StartHandler, diameter, windowData);
        }
        ...
        {
            ModelBall newBall = new ModelBall(position.x - diameter / 2, position.y - diameter / 2, ball) { Diameter = diameter };
